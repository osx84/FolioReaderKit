...
class FolioReaderChapterList: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // self.folioReader.isNight(self.readerConfig.nightModeMenuBackground, self.readerConfig.menuBackgroundColor)
        self.tableView.separatorColor = .separator
        // self.folioReader.isNight(self.readerConfig.nightModeSeparatorColor, self.readerConfig.menuSeparatorColor)
